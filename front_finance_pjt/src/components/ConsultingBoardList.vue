...
import ConsultingBoardListItem from './ConsultingBoardListItem.vue';
...
const updatePagination = () => {
  ...
  const reversedBoards = store.consultingBoards.slice().reverse()
...
watch(() => store.consultingBoards, updatePagination)
